const monthColors: Array<{bg: string, text: string}> = [
  {bg: '#4A46D1', text: '#ffffff'}, // january
  {bg: '#6BAEFA', text: '#ffffff'}, // feb
  {bg: '#4DD98C', text: '#000000'}, // mar
  ...
  {bg: '#3a37a3', text: '#ffffff'}, // december
];
