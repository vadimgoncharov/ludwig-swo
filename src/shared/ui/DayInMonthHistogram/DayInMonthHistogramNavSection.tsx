...
export default class DayInMonthHistogramNavSection extends React.Component<TProps, void> {
      ...
      onUpdate: () => {
        ...
        svgRects.forEach((svgRect, index) => {
            if (index === newSelectedIndex) {
              svgRect.classList.add('DayInMonthHistogramSvgSelected');
            } else {
              svgRect.classList.remove('DayInMonthHistogramSvgSelected');
            }
        });
      },
    });
