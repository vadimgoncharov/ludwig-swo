...
import StatYearDaysSorted from '../components/StatYearDaysSorted';
...
class StatYearDaysSortedContainer extends React.Component<TStateFromProps & DispatchProp<TDispatch>, any> {
  public render() {
    const {
      isFetching,
      statDayInYear,
...
export default connect<TStateFromProps, null, null>(mapStateToProps)(StatYearDaysSortedContainer);
